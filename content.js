...
function applyStyles(settings) {
  ...
  // --- 1. Handle Font Styles (Set Vazirmatn Font) ---
  ...
  if (isFontActive) {
    ...
    // Inject the font-related CSS rules
    fontStyleElement.textContent = `
            /* Import the Vazirmatn and Rubik fonts from Google Fonts */
...
chrome.storage.sync.get(["setFont", "expandedMode"], (settings) => {
